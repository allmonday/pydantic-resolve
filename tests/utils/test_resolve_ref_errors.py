...
def test_multiple_colons_in_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls='tests.utils.test_resolve_ref_errors:User', loader=None)
        ]
        id: int
        user_id: int
...
def test_missing_module_name_before_colon():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls=':User', loader=None)
        ]
        id: int
        user_id: int
...
def test_missing_class_name_after_colon():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls='tests.utils:', loader=None)
        ]
        id: int
        user_id: int
...
def test_module_exists_but_class_not_found():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls='builtins:NonExistentClass', loader=None)
        ]
        id: int
        user_id: int
...
def test_simple_class_name_not_found_in_module():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls='NonExistentClass', loader=None)
        ]
        id: int
        user_id: int
...
def test_nested_list_generic_with_string_ref():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls=list[list['User']], loader=None)
        ]
        id: int
        user_id: int
...
def test_other_container_types():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='items',field_name='user',target_kls=tuple['User'], loader=None),
        ]
        id: int
        user_id: int
...
def test_dict_generic_with_string_ref():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='mapping',field_name='user',target_kls=dict[str, 'User'], loader=None),
        ]
        id: int
        user_id: int
...
def test_valid_list_generic_with_string_ref():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls=list['User'], loader=None)
        ]
        id: int
        user_id: int
...
def test_list_generic_with_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(field='user_id',field_name='user',target_kls=list['tests.utils.test_resolve_ref_errors:User'], loader=None)  # noqa: F722
        ]
        id: int
        user_id: int
...
def test_empty_string_class_name_in_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            Relationship(field='user_id',field_name='user',target_kls='tests.utils.test_resolve_ref_errors:', loader=None)
        ]
        id: int
        user_id: int
...
def test_invalid_module_in_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            Relationship(field='user_id',field_name='user',target_kls='totally.fake.module:User', loader=None)
        ]
        id: int
        user_id: int
