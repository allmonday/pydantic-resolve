...
def test_multiple_colons_in_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target='tests.utils.test_resolve_ref_errors:User', loader=None)
        ]
        id: int
        user_id: int
...
def test_missing_module_name_before_colon():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target=':User', loader=None)
        ]
        id: int
        user_id: int
...
def test_missing_class_name_after_colon():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target='tests.utils:', loader=None)
        ]
        id: int
        user_id: int
...
def test_module_exists_but_class_not_found():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target='builtins:NonExistentClass', loader=None)
        ]
        id: int
        user_id: int
...
def test_simple_class_name_not_found_in_module():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target='NonExistentClass', loader=None)
        ]
        id: int
        user_id: int
...
def test_nested_list_generic_with_string_ref():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target=list[list['User']], loader=None)
        ]
        id: int
        user_id: int
...
def test_other_container_types():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='items',name='user',target=tuple['User'], loader=None),
        ]
        id: int
        user_id: int
...
def test_dict_generic_with_string_ref():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='mapping',name='user',target=dict[str, 'User'], loader=None),
        ]
        id: int
        user_id: int
...
def test_valid_list_generic_with_string_ref():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target=list['User'], loader=None)
        ]
        id: int
        user_id: int
...
def test_list_generic_with_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            ...
            Relationship(fk='user_id',name='user',target=list['tests.utils.test_resolve_ref_errors:User'], loader=None)  # noqa: F722
        ]
        id: int
        user_id: int
...
def test_empty_string_class_name_in_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            Relationship(fk='user_id',name='user',target='tests.utils.test_resolve_ref_errors:', loader=None)
        ]
        id: int
        user_id: int
...
def test_invalid_module_in_module_path():
    ...
    class MyEntity(BaseModel, Base):
        __relationships__ = [
            Relationship(fk='user_id',name='user',target='totally.fake.module:User', loader=None)
        ]
        id: int
        user_id: int
